...
def rapid_signal_spikes(img, prev_frames=None, binary_mask=None, testmode=False, exinfo=None, presetROIsize=None,
                            min_dist=30, thresh_abs=0.3, num_peaks=10, noise_level=5, smoothing_radius=1,
                            ensure_spacing=0, border_limit=10, init_smooth=1):
    """
    Common parameters:
    img - current image,
