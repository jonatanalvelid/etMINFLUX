...
def peak_detection_dim(img_ch1, prev_frames=None, binary_mask=None, exinfo=None, presetROIsize=None,
    ...
    """
    Analysis pipeline similar to the other peak detection pipelines, but instead returning the coordinates with the dimmest peaks first.
