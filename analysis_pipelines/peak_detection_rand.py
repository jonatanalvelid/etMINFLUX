...
def peak_detection_rand(img_ch1, prev_frames=None, binary_mask=None, exinfo=None, presetROIsize=None,
    ...
    coord_num_lim_lo - lower index limit of the random peak index to return
    coord_num_lim_hi - lower index limit of the random peak index to return
    """
    roi_sizes = False
    ...
    # generate random coordinate number to use from the user-provided inputs, if we have enough coordinates
    if len(coordinates) > coord_num_lim_lo:
