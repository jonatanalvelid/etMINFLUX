...
- If a simulation version of etMINFLUX is requested, adjust the system_simulation parameter in etMINFLUX_setup.json (true = simulated, false = MINFLUX microscope and specpy required).
  
In order to run event-triggered recordings, some settings need to be adjusted in Imspector and etMINFLUX_setup.json.
